...
angular.module('ui.bootstrap.datetimepicker', ['ui.bootstrap.dateparser', 'ui.bootstrap.position'])
    ...
    .directive('datePickerWrap', function () {
        return {
            ...
            replace: true,
            transclude: true,
            templateUrl: 'views/partials/date-picker.html'
        };
    })
    ...
    .directive('timePickerWrap', function () {
        return {
            ...
            replace: true,
            transclude: true,
            templateUrl: 'views/partials/time-picker.html'
        };
    });
...
angular.module('ui.bootstrap.datetimepicker').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/partials/date-picker.html',
  ...
  $templateCache.put('views/partials/time-picker.html',
